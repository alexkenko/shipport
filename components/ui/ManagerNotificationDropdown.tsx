...
import { ManagerNotification } from '@/hooks/useManagerNotifications'

interface ManagerNotificationDropdownProps {
...
export function ManagerNotificationDropdown({
  ...
  onMarkAsRead,
  onMarkAllAsRead
}: ManagerNotificationDropdownProps) {
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {notification.job_title && (
                        <div className="flex items-center mt-2 space-x-2">
                          ...
                          {notification.superintendent_company && (
                            <>
